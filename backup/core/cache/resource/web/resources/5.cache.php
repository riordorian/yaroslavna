<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p class="zakaz_descr">Для того, чтобы заказать икону в нашей иконописной мастерской, Вы можете позвонить в мастерскую по телефону, указанному в разделе контактов, написать нам на адрес электронной почты или оставить заявку на сайте.</p>
		    <h1 class="zakaz_header">Заказать икону</h1>
		    <form action="" name="zakaz">
			<div class="left_part_zakaz">
				<p class="placeholder">Имя<span class="red">*</span></p>
				<p class="placeholder">Телефон<span class="red">*</span></p>
				<p class="placeholder">Сообщение<span class="red"></span></p>
			</div>
			<div class="right_part_zakaz">
				<input type="text" class="in_form" name="fio" mandatory=true>
				<input type="text" class="in_form" name="phone" mandatory=true>
				<textarea name="comment" id="in_form_area" cols="30" rows="10"></textarea>
			</div>
			<div class="btn_order" onclick="send(\'zakaz\')">Отправить</div>
			<p class="status"><span class="red">* </span><span class="status_text">Поля обязательные для заполнения</span></p>
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1416153215,
    'editedby' => 1,
    'editedon' => 1473848383,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1416153180,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<div class="main_content">
     <div class="fix">
<p class="zakaz_descr">Для того, чтобы заказать икону в нашей иконописной мастерской, Вы можете позвонить в мастерскую по телефону, указанному в разделе контактов, написать нам на адрес электронной почты или оставить заявку на сайте.</p>
		    <h1 class="zakaz_header">Заказать икону</h1>
		    <form action="" name="zakaz">
			<div class="left_part_zakaz">
				<p class="placeholder">Имя<span class="red">*</span></p>
