...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'separator' => '<span>&nbsp;»&nbsp;</span>',
			'href' => $this->url->link('product/sections')
		);
...
//					$image = '/image/' . $result['image'];
			...
			$data['results'] = sprintf($this->language->get('text_pagination'), ($product_total && (int)$page > 0) ? (($page - 1) * $limit) + 1 : 0, ((($page - 1) * $limit) > ($product_total - $limit) || (int)$page == 0) ? $product_total : ((($page - 1) * $limit) + $limit), $product_total, ceil($product_total / $limit));
