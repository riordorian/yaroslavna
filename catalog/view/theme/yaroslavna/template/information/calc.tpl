...
<div class="row">
    <div class="col-md-6">
        <form name="Kalkulator" class="popup-form">
            <table class="calctext" border="0">
                ...
                <tr>
                    ...
                    <td style="text-align: left;">
                        <input id="i_height" class="calc_inp form__field" onkeyup="validate(this);calcsum(this.form)" name="i_height" placeholder="0" size="2" onchange="validate(this);calcsum(this.form)" align="middle" type="number">
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left;">Ширина, см.</td>
                    <td style="text-align: left;">
                        <input id="i_width" class="calc_inp form__field" onkeyup="validate(this);calcsum(this.form)" name="i_width" placeholder="0" size="2" onchange="validate(this);calcsum(this.form)" align="middle" type="number">
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left;"><strong>Площадь, дм<sup>2</sup></strong></td>
                    <td style="text-align: left;">
                        <input class="itog_inp form__field" name="i_area" placeholder="0" disabled="disabled" size="5" align="middle" type="text">
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left;" colspan="2" height="25">
                ...
                <tr>
                    ...
                    <td style="font-size: 22px; color: #299a66; text-align: left;">
                        <input class="itog_inp form__field" name="i_summ" disabled="disabled" size="6" type="text"> руб
                    </td>
                </tr>
                <!--<tr>
            ...
            <p>
                <h4 style="color: #000000;"><em>&nbsp;Внимание! Цена является ориертировочной. Точную цену узнавайте у менеджера.</em><strong><br></strong></h4>
            </p>
        </form>
    </div>
</div>
